  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className="text-group" style={{ marginButtom: '30px' }}>
            <Typography sx={{ fontSize: '3em', color: '#fff', fontFamily: 'GmarketSansMedium' }}>기후에 따른 옷차림 추천</Typography>
            <Typography sx={{ fontSize: '3em', color: '#fff', fontFamily: 'GmarketSansMedium' }}>당신의 기상 패션 가이드</Typography>
          </div>
