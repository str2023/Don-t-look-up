    ...
    >
      ...
      <Box sx={{ width: '100%', display: 'flex', justifyContent: 'center' }}>
          ...
          <Box sx={{ width: '30%', margin: '2em', }}>
                ...
                <LineChart width={chartWidth} height={chartHeight} data={carbonEmissionData} margin={{ top: 5,  left: 10, bottom: 5 }} sx={{ marginTop: '2em' }}>
          ...
          <Box sx={{ width: '30%', margin: '2em', }}>
            ...
            <LineChart width={chartWidth} height={chartHeight} data={tempChangeData} margin={{ top: 5, left: 10, bottom: 5 }} sx= {{ marginTop: '2em' }}>
              <CartesianGrid strokeDasharray="3 3" />
              <XAxis dataKey="year" label={{ value: '년도', position: 'insideBottomLeft', offset: -10, style: {fontSize: '1.2rem'}  }} />
          ...
          <Box
            ...
            >
              ...
              >
                ...
                최적의 옷차림을 추천해드립니다.<br />
                기상 상태에 따른 행동방침과 액티비티, <br />그리고 기상정보문도요! <br />
                이로써, 여러분이 날씨에 따른 옷차림을<br />
                고민하는 시간을 절약하고,<br />
                기후변화에 적응하는 데 도움을 줄 수 있습니다.<br />
                지금 바로 시작해보세요!
              </Typography>
              <Button
                variant="contained"
